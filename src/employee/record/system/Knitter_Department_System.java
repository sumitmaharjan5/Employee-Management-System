...
public class Knitter_Department_System extends JFrame {

    JTable table;
    Choice cemployeeId;
    JButton search, print, update;

    Knitter_Department_System() {
        setLayout(null);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/knitting.png"));
        ...
        JLabel hello = new JLabel("Knitting");
...
//        
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from employee where position='Knitter'");
            while (rs.next()) {
