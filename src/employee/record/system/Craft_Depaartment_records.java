...
public class Craft_Depaartment_records extends JFrame {

    JTable table;
    Choice cemployeeId;
    JButton search, print, update;

    Craft_Depaartment_records() {
        setLayout(null);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/craft.png"));
...
//        
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from employee where position='Crafter'");
            while (rs.next()) {
