...
public class Disigner_Department_System extends JFrame {

    JTable table;
    Choice cemployeeId;
    JButton search, print, update;

    Disigner_Department_System() {
        setLayout(null);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/designer.png"));
        ...
        JLabel hello = new JLabel("Designer");
...
//        
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from employee where position='Designer'");
            while (rs.next()) {
...
//
    ...
    public static void main(String[] args) {
        new Disigner_Department_System();
    }
}
